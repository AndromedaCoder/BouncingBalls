...
public class MainDisplayActivity extends AppCompatActivity implements SurfaceHolder.Callback, SensorEventListener
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_main_display_activity);
    ...
    {
        mGraphics = new GraphicsHandler(holder);
        mThread = new Thread(
                mGraphics
        );
        mThread.start();
    ...
    {
        Toast t = Toast.makeText(getApplicationContext(), "Surface changed",
                Toast.LENGTH_SHORT);
        t.show();
    }
